...
func TestAggregateCompletion_BasicSSE(t *testing.T) {
	...
	out, err := aggregateCompletion(strings.NewReader(sse), "test-model", 200, nil)
	if err != nil {
...
func TestAggregateCompletion_Empty(t *testing.T) {
	_, err := aggregateCompletion(strings.NewReader(""), "test", 200, nil)
	if err != nil {
...
func TestAggregateCompletion_NoDone(t *testing.T) {
	...
	out, _ := aggregateCompletion(strings.NewReader(sse), "m", 200, nil)
